         ...
         <div className="relative">
           ...
           {showMenu && (
             <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10">
               <button onClick={() => { onEditUsername(); setShowMenu(false); }} className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-left">Edit Username</button>
               <button onClick={logout} className="flex items-center gap-2 px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-left">
                 <LogoutIcon />
                 Logout
               </button>
             </div>
       ...
       <div className="container mx-auto px-4 py-8">
         ...
         <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
           ...
           <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-xl p-8 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border border-gray-200 dark:border-gray-800 flex flex-col items-center text-center">
             ...
             <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Create a Room</h2>
             <p className="text-gray-600 dark:text-gray-400 mb-8 flex-grow">
               Start a new private room and invite your friends.
             </p>
             <button onClick={onCreateRoom} className="w-full bg-black dark:bg-white text-white dark:text-black py-3 rounded-lg font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors duration-300 shadow-lg">
               Start a New Stream
             </button>
           </div>
           ...
           <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-xl p-8 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border border-gray-200 dark:border-gray-800 flex flex-col items-center text-center">
             ...
             <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Join a Room</h2>
             <p className="text-gray-600 dark:text-gray-400 mb-8 flex-grow">
             ...
             <form onSubmit={handleJoinRoom} className="w-full space-y-4">
               ...
               />
               <button type="submit" disabled={!roomId.trim()} className="w-full bg-black dark:bg-white text-white dark:text-black py-3 rounded-lg font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed">
                 Join Room
               </button>
             </form>
           </div>
